      ...
      {services.length && (
        <>
          <div className="app__services-item app__flex">
            <img src={urlFor(services[currentIndex].imgurl)} alt={services[currentIndex].name} />
          ...
          <div className="services-btns app__flex">
            <div className="app__flex" onClick={() => handleClick(currentIndex === 0 ? services.length - 1 : currentIndex - 1)}>
              <HiChevronLeft />
            </div>

            <div className="app__flex" onClick={() => handleClick(currentIndex === services.length - 1 ? 0 : currentIndex + 1)}>
              <HiChevronRight />
            </div>
          </div>
        </>
